...
public class ExerciseAdapter implements JsonDeserializer<Exercise>{ //implements JsonDeserializer<Exercise> {

    private final static String PACKAGE_EXERCISES_IMPL = "fr.uca.cdr.skillful_network.entities.simulation.exercise.";
//
    @Override
        ...
        try {
            ...
            throw new RuntimeException(
                    PACKAGE_EXERCISES_IMPL + jsonObject.get("type").getAsString() + " could not be found." +
                                        ...
                                        "fr.uca.cdr.skillful_network.entities.simulation.exercises.", e);
        }
    }
